import { jiraMacketProjectKeyInfo, jiraProjectKeyData } from '../Makcets/getMacketForJira';
import { userLabel } from '../Makcets/getMacketInfo'
import requestsToJira from '../Requests/requestsToJira'
import { isAccountIdExistInList } from './Tools/tools';

async function getInfoFromJira(dates, basicToken) {

    const jiraResponses = await requestsToJira(basicToken);
